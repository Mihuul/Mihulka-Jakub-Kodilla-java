...
public class BoardTestSuite {
    ...
    @Test
    void testAddTaskListUsersTasks(){
        //Given
        Board project = prepareTestData();
        //When
    ...
    void testAddTaskListAverageWorkingOnTask() {
        ...
        double result  = project.getTaskLists().stream()
                ...
                .flatMap(l -> l.getTasks().stream())
//                .mapToLong(n -> n.getCreated().until(n.getDeadline(),ChronoUnit.DAYS))
                .mapToLong(n-> ChronoUnit.DAYS.between(n.getCreated(), n.getDeadline()))
                .average().getAsDouble();
        //Then
        assertEquals(18.3, result, 1);
    }
